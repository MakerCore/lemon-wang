...
date: "2026-06-01"
tags: ["full-color-3d-printing", "market-analysis", "user-research", "tabletop-gaming"]
...
description: "Field notes from UK Games Expo 2026 on the real buyer for full-color 3D printing: young tabletop wargamers who want painted miniatures without the painting bottleneck."
hot: true
---
...
- The strongest early market for full-color 3D printing is not the generic family consumer. It is the miniature wargamer who wants to play, not paint.
- The value is not "cheaper plastic." The value is removing a 6-7 hour painting bottleneck while keeping control over files, scale, and production timing.
- Multi-color FDM proves users will accept printed color. Full-color inkjet wins when photographic texture, more colors, and no painting matter more than low material cost.

## Field FAQ

**Who are the real users of full-color 3D printing?**
Young tabletop wargamers, small studios, and creators who want finished-looking miniatures or terrain without the painting labor.

**Why is "family consumer" the wrong positioning?**
Families do not yet have a painful enough job-to-be-done. Wargamers already spend money on miniatures, terrain, paints, and tools, and many of them are blocked by painting time.

**Should full-color 3D printing be sold as a service or a printer?**
For this market, the printer is the stronger wedge. Wargamers and studios care about control: the file, the variant, the scale, and the timing.
