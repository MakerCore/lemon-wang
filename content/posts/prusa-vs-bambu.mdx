...
![Catastrophic vs. Wow Moments — Prusa users rage, Bambu users evangelize](/catastrophic-vs-wow.webp)
...
>
> **Source:** Data processed via **[User's Voice](https://fdm-multicolor.usersvoice.lemon.wang)**, an intelligence tool for the 3D printing industry.
> - FDM Multi-color: [fdm-multicolor.usersvoice.lemon.wang](https://fdm-multicolor.usersvoice.lemon.wang)
