...
description: "Inside Mantic Games' Nottingham print room: why £500 desktop resin printers beat a €26,000 industrial machine for 10mm miniatures, and what that says about demand creation in 3D printing."
hot: true
---
...
- Cheap desktop 3D printers are not just replacing expensive industrial machines. In Mantic's 10mm miniature line, they make products possible that older processes cannot make economically at all.
- Some demand does not pre-exist capacity. Once a cheap, rackable production method exists, new formats, smaller scales, and faster product cycles become commercially visible.
- Full-color 3D printing is strongest where sculpt detail matters less than instant visual readability: armies, terrain, and small tabletop pieces that collapse under hand-painting.

## Field FAQ

**Why did a £500 desktop printer beat a €26,000 industrial machine?**
Because the cheaper printers fit the job. Mantic needed rackable, low-cost capacity for tiny 10mm miniatures. The industrial machine was precise, but its economics were built for a different kind of demand.

**What does this say about full-color 3D printing?**
Color is the next missing layer. Monochrome desktop printers already proved that cheap distributed capacity can create new miniature formats. Full-color printing can remove the painting bottleneck in the same part of the market.

**Who is the likely buyer?**
Small studios, tabletop creators, and serious wargamers who need many small pieces to read clearly on the table without hours of hand-painting.
