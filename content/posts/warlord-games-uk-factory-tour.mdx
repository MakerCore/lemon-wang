...
date: "2026-06-07"
tags: ["factory-tour", "3d-printing", "full-color-3d-printing", "manufacturing"]
...
description: "Inside Warlord Games' Nottingham factory: resin casting, metal spin-casting, injection molding, and why tabletop miniatures still resist full automation."
hot: true
---
...
![Warlord Towers - Warlord Games HQ](/warlord-hero.webp)
...
![Red Devils - painted vs unpainted resin comparison](/warlord-resin.webp)
...
![Black Powder cavalry - Warlord Games product line](/warlord-cavalry.webp)
...
![Warlord Games HQ Store - Bolt Action gaming table](/warlord-store.webp)
...
- Warlord Games keeps four production methods under one roof because each one owns a different job: validation, small batch, long-tail demand, or flagship scale.
- Hand production is not always nostalgia. In niche miniature manufacturing, it can be the cheapest way to keep obscure products alive.
- Full-color 3D printing did not face rejection here. It faced a knowledge gap. A physical sample changed the conversation faster than a pitch could.

## Field FAQ

**Why does Warlord Games still use hand casting?**
Because many historical miniatures are too niche for injection tooling but still valuable to players. Silicone molds and hand casting keep those long-tail products economically possible.

**Why not replace resin casting with 3D printing today?**
For production parts, Warlord still worries about durability and ageing resistance. They use 3D printing for prototypes, but not yet as the main production process.

**Where does full-color 3D printing fit?**
It fits where painting is the bottleneck and color is part of the product value. The market is not fully aware yet, which makes direct sampling more important than abstract marketing.
